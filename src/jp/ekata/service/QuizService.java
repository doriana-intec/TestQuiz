package jp.ekata.service;
import jp.ekata.question_interface.QuizQuestions;
import jp.ekata.question_interface.implementations.AdditionQuestions;
import jp.ekata.question_interface.implementations.SubtractionQuestions;
...
public class QuizService {
    ...
    public  void createQuiz() {
        ...
        for (int i = 0; i < 10; i++) {
            if (Math.random() < 0.5) {
                questions[i] = new AdditionQuestions();
            } else {
                questions[i] = new SubtractionQuestions();
            }
        }
    }
